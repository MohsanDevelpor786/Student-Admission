...
<div class="bg-light">
    <!-- Home Section -->
    <section class="home-section-react d-flex align-items-center text-center text-white">
        <div class="container">
            <h2 class="mb-2">Welcome to Our React Course</h2>
            <p>Learn modern web technologies with real-world hands-on practice.</p>
            <a href="course-react.php" class="btn btn-light btn-lg mt-2 fw-semibold shadow-sm">Join Now</a>
        </div>
    </section>

    <div class="container pt-3 pb-4 course-react-design">
        <div class="row align-items-center">
            <h2 class="text-center mb-4">Welcome To our Frontend Course!</h2>
            <!-- Left Side: Image -->
            <div class="col-lg-6 col-md-12 col-sm-12 mb-3">
                <img src="./assets/images/home-image.jpg" alt="Sample Image" class="img-fluid rounded shadow">
            </div>
            ...
            if (isset($_POST['submit'])) {
                ...
                // Insert query
                $query = "INSERT INTO reactjs (name, duration, payment, email, password) 
                ...
                <div>
                    ...
                    <div class="border-0">
                        <form method="POST" action="" class="card p-3">
                            <h3 class="text-center">Addmission for React</h3>
                            <div class="main-react d-flex gap-3">
